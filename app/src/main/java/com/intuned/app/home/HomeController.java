...
public class HomeController extends AppCompatActivity {
    ...
    private void initObjects() {
        ...
        seekDialog = new ProgressDialog(HomeController.this);
    ...
    private void setValues() {
        ...
        newSongIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AudioManager manager = (AudioManager) HomeController.this.getSystemService(Context.AUDIO_SERVICE);
                //Validate user is playing music.
                if (manager.isMusicActive()) {
                    if (ModalService.displayConfirmation("Post Song?", "This song will be available for others to listen to.", HomeController.this)) {
                        ...
                        for (Song song : listOfUserSongs) {
                            ...
                            if (songId.equals(currentSongId)) {
                                ...
                                try {
                                    ...
                                    ModalService.displayTest(e.getMessage(), HomeController.this);
                                }
                    ...
                    ModalService.displayToast("Turn on your music first...", HomeController.this);
                }
            }
        });
    }
    ...
    private void uploadSongToFirebaseStorage(File file, final Song song) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                ModalService.displayNotification("Error", exception.getMessage(), HomeController.this);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                vibe.song = song;
                vibe.emotion = "Happy";
                firebase.child(AppConfig.TABLE_USERS).child(sessionManager.getUserInstance().id).child("vibe").setValue(vibe);
                ModalService.displayNotification("Success", "Your song has been uploaded.", HomeController.this);
            }
        });
    }
        ...
        firebase.child(AppConfig.TABLE_USERS).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    //InTuned Track - Title
                    song.title = (String) child.child("vibe").child("song").child("title").getValue();
                    //InTuned Track = ID
                    song.id = (String) child.child("vibe").child("song").child("id").getValue();
                    //InTuned Track = Artist
                    song.artist = (String) child.child("vibe").child("song").child("artist").getValue();
                    //InTuned Track = Album
                    song.album = (String) child.child("vibe").child("song").child("album").getValue();
                    //InTuned Track = Filename
                    song.fileName = (String) child.child("vibe").child("song").child("fileName").getValue();
                    //Emotion of Vibe
                    vibe.emotion = (String) child.child("vibe").child("emotion").getValue();
                    vibe.song = song;
                    //Username
            ...
            public void onCancelled(FirebaseError error) {
                ModalService.displayNotification("Lost connection to database, please try again.", "Sorry", HomeController.this);
            }
        });
    }
    ...
    private class SongItemAdapter extends SongListAdapter<SongListAdapter.SongViewHolder> {
        ...
        public void onBindViewHolder(SongViewHolder songViewHolder, int position) {
            ...
            if (songViewHolder instanceof SongViewHolder) {
                songViewHolder.name.setText(user.vibe.song.title);
                songViewHolder.artist.setText(user.vibe.song.artist);
    ...
    private void initRecyclerView() {
        ...
        postedSongsRecyclerview.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                User user = songItemAdapter.getItem(position);
                playSong(position, user.vibe.song.fileName);
            }
        }));
